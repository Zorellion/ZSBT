...
ZSBT.DEFAULTS = {
    profile = {
		...
		notificationsRouting = {
			...
			playerXP = "Notifications",
			honor = "Notifications",
			reputation = "Notifications",
			companionXP = "Notifications",
		...
		notificationsPerType = {
			...
			playerXP = { style = { fontOverride = false }, sound = { enabled = false, soundKey = "None" } },
			honor = { style = { fontOverride = false }, sound = { enabled = false, soundKey = "None" } },
			reputation = { style = { fontOverride = false }, sound = { enabled = false, soundKey = "None" } },
			companionXP = { style = { fontOverride = false }, sound = { enabled = false, soundKey = "None" } },
